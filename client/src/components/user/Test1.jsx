   ...
   return (
      <div className='w-full '>
         ...
         <div className='justify-center items-center flex-col mb-6'>
            <h1 className='text-2xl font-semibold items-center flex justify-center mb-4'>Ready to get started ?</h1>
           <div className='justify-center flex'>
           <button className='bg-button border border-gray flex rounded-md h-3rem -mt-2 justify-center items-center w-48'>
               <CgHome className="mx-1 text-2xl text-white h-8 justify-center items-center " /><span className='text-white font-bold mx-1 justify-center items-center '>Holiday Setup</span>
            </button>
           </div>
